...
var vegetables = ['Green Peppers', 'Red Peppers', 'Lettuce', 'Carrots', 'Celery']
...
// different fruits.
var fruits = ['Grapes', 'Apples', 'Oranges', 'Lemons', 'Lime', 'Kiwi', 'Raspberry']
...
// Additional values to add would be location, hours, unique facilities.
